...
const PromotionCard = () => {
  return (
    <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl shadow-lg p-8 flex flex-col items-center justify-center mx-auto w-11/12 lg:w-full">
